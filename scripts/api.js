...
export class Line {
    ...
    Append(
        ...
        if (Style.Gradient && Style.Gradient.ColorMatrix.Matrix.length > 0) {
            Line.style.backgroundImage = `linear-gradient(to right, ${Style.Gradient.ColorMatrix.Matrix.join(", ")})`;
        } else {
