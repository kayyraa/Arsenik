...
export const SimulationResetButton = document.querySelector(".SimulationResetButton");

export const SimulationFrameLabel = document.querySelector(".SimulationFrameLabel");
export const SimulationFpsLabel = document.querySelector(".SimulationFpsLabel");
...
export class Line {
    ...
    Connect(
        ...
        const ElectronAffinity = (Rom.Elements.find((Object) => Object.Symbol === this.Connection[0].innerHTML).ElectronAffinity + Rom.Elements.find((Object) => Object.Symbol === this.Connection[1].innerHTML).ElectronAffinity) / 2;
        Line.querySelectorAll("span")[1].innerHTML = ElectronAffinity > 0 ? "(-)" : "(+)";
